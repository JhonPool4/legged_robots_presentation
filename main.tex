...
\begin{document}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\only<5>{\item Gastrocnemius muscle (GAS) relates knee flexion and ankle plantarflexion
			...
			\begin{overprint}
				...
				\begin{columns}
					...
					\begin{column}{.5\textwidth}
						...
						\subfloat[Ankle plantarflexion]{\includegraphics[height=.20\textheight]{images/ankle_planarflexion.pdf}}
					\end{column}  
				\end{columns}
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\centering
				\includegraphics[height=.29\textheight]{images/table_quantity_articulation.pdf}
				\caption{Maximum cross-correlation coefficients R for each quantity}	
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{.5\textwidth}
			\begin{figure}
				\centering
				\includegraphics[height=.32\textheight]{images/stance_table.pdf}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{.5\textwidth}
			\begin{figure}
				\centering
				\includegraphics[height=.23\textheight]{images/swing_table.pdf}
