...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\centering
				\includegraphics[height=.32\textheight]{images/table_quantity_articulation.pdf}
				\caption{Maximum cross-correlation coefficients R for each quantity}	
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{.5\textwidth}
			\begin{figure}
				\centering
				\includegraphics[height=.35\textheight]{images/stance_table.pdf}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{.5\textwidth}
			\begin{figure}
				\centering
				\includegraphics[height=.28\textheight]{images/swing_table.pdf}
